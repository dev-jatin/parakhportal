        ...
        <HStack h={"90%"} w={"100%"}>
          ...
          >
            ...
            <HStack>
              ...
              <Text fontSize={"2xl"}> AI BASED LEARNING</Text>
            </HStack>
            <Text fontSize={"26px"} fontWeight={"semibold"} color={"whiteAlpha.900"}>
              Welcome
            </Text>
          ...
          >
            ...
            >
              ...
              <HStack
                ...
                pl={"20px"}
              >
                <Text alignItems={"flex-start"} fontSize={"15px"}>
                ...
                <Text fontSize={"15px"}>
                  {" "}
                  4. IMPORTANT: Please raise grievance in https://css.aicte-india.org/, if OTP is
                  not received on registered email or mobile number.
                </Text>
              </HStack>
            </HStack>
            ...
            <HStack w={"50%"}>
              <HStack w={"70%"} flexDir={"column"}>
                <Text fontWeight={"semibold"} color={"blue.500"} fontSize={"20px"}>
                  Sign In
                </Text>
                <InputGroup>
